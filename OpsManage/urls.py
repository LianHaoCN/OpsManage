...
urlpatterns = [
    ...
    url(r'^cron_file_distribution', cron.cron_file_distribution),
    url(r'^cron_run/(?P<cid>.*)/$', cron.cron_run),
    url(r'^cron_result/(?P<cid>.*)$', cron.cron_result),
    url(r'^cron_script_execution', cron.cron_script_execution),
    ...
    url(r'^deploy_template_list',deploy.deploy_template_list),
	url(r'^deploy_template_add',deploy.deploy_template_add),
	url(r'^deploy_template_modf/(?P<pid>[0-9]+)/$',deploy.deploy_template_modf),
	url(r'^deploy_template_change/(?P<pid>[0-9]+)/$',deploy.deploy_template_change),
    url(r'^deploy_generate_by_template$',deploy.deploy_generate_by_template),
	...
	url(r'^api/deploy/template/(?P<tid>[0-9]+)/$', deploy_api.deploy_template_detail),
